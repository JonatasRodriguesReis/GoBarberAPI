...
describe('List Provider Month Availability', () => {
  it('Should be able to list the month availability from provider', async () => {
    ...
    const listProviderMonthAvailability = new ListProviderMonthAvailability(fakeAppointmentRepository);
    ...
    const availibity = await listProviderMonthAvailability.execute(
      {
        provider_id: 'user',
        year: 2020,
        month: 5
